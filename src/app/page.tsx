...
export default function Home() {
  ...
  return (
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 bg-gradient-to-b from-white/80 via-transparent to-amber-900/60" />

      {/* Navbar */}
      <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px- py-7">
        ...
        <div className="flex flex-1 items-center justify-center px-7">
          <div className="w-full max-w-xl rounded-full bg-amber-900/80 px-6 py-2 backdrop-blur-md ring-1 ring-white/20 object-cover transform transition-transform duration-700 ease-out hover:scale-110 filter sepia-[0.3] saturate-75">
            <input
              type="text"
              placeholder="search"
              className="w-full bg-transparent text-2xl tracking-wide text-white placeholder-white/80 outline-none"
            />
          </div>
        </div>
        <div className="hidden gap-4 md:flex">
          <Link
            href="/"
            className="rounded-full bg-amber-900/80 px-6 py-2 text-lg font-semibold text-white 
          ...
          <Link href="#about" className="rounded-full bg-amber-900/80 px-6 py-2 text-lg font-semibold text-white hover:bg-amber-800/80 transition-colors object-cover transform transition-transform duration-700 ease-out hover:scale-110 filter sepia-[0.3] saturate-75"><TranslatedText translationKey="ABOUT" /></Link>
          <Link href="/login" className="rounded-full bg-amber-900/80 px-6 py-2 text-lg font-semibold text-white hover:bg-amber-800/80 transition-color object-cover transform transition-transform duration-700 ease-out hover:scale-110 filter sepia-[0.3] saturate-75">LOGIN</Link>
          <Link href="/signup" className="rounded-full bg-amber-900/80 px-6 py-2 text-lg font-semibold text-white hover:bg-amber-800/80 transition-colors object-cover transform transition-transform duration-700 ease-out hover:scale-110 filter sepia-[0.3] saturate-75">SIGN UP</Link>
          <Link href="#contact" className="rounded-full bg-amber-900/80 px-6 py-2 text-lg font-semibold text-white hover:bg-amber-800/80 transition-colors object-cover transform transition-transform duration-700 ease-out hover:scale-110 filter sepia-[0.3] saturate-75">CONTACT</Link>
      ...
      <main className="relative z-10 flex items-center justify-center">
        ...
        <div className="relative mt-16 flex h-[65vh] w-[65vh] max-w-[92vw] items-center justify-center  transition-all duration-1000 ease-out opacity-0 animate-fade-in-scale">
          <img
            src="https://m.media-amazon.com/images/I/71vvz-QhStL.jpg"
            alt="center statue"
            className="h-full w-full rounded-full object-contain drop-shadow-[0_20px_60px_rgba(92,37,8,0.6)] filter brightness-110 contrast-110"
      ...
      <section
        ...
        className={`relative z-10 bg-[khaki]/10 text-white flex items-center transition-all duration-1000 delay-300 ${artisansInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            <h2 className="text-7xl font-bold text-amber-900 mb-6 drop-shadow-sm animate-fade-in-up delay-200" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              <TranslatedText translationKey="featuredArtisans" />
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="bg-amber-900/80 drop-shadow-md from-cream-50 to-amber-50 backdrop-blur-lg rounded-3xl p-8 hover:scale-105 transition-all duration-500 border border-amber-200/50 shadow-xl hover:shadow-2xl">
      ...
      <section
        ...
        className={`relative z-10 min-h-screen bg-[khaki]/10 flex items-center transition-all duration-1000 delay-400 ${categoriesInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-16">
            <h2 className="text-7xl font-bold text-stone-800 mb-6 drop-shadow-sm  animate-fade-in-up delay-200" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
              <TranslatedText translationKey="craftCategories" />
            </h2>
            <p className="text-2xl text-stone-700 max-w-4xl mx-auto leading-relaxed  animate-fade-in-up delay-200">
              <TranslatedText translationKey="craftCategoriesDescription" />
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { name: 'Textiles', img: 'https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=200' },
              { name: 'Pottery', img: 'https://images.unsplash.com/photo-1594736797623-d0b6b5d0c42b?w=200' },
              { name: 'Jewelry', img: 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=200' },
              { name: 'Woodwork', img: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=200' },
              { name: 'Metalcraft', img: 'https://images.unsplash.com/photo-1565814576633-e9a0cb901b10?w=200' },
              { name: 'Paintings', img: 'https://images.unsplash.com/photo-1578769503985-e0a07d7bbdd9?w=200' },
              { name: 'Sculptures', img: 'https://images.unsplash.com/photo-1582582494409-7e4d7c5b0d7a?w=200' },
              { name: 'Ceramics', img: 'https://images.unsplash.com/photo-1565814576524-7fcb5e516c8e?w=200' }
            ].map((category) => (
              <div key={category.name} className="group bg-amber-900/90  rounded-2xl p-6 hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-2xl border border-amber-300/30">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { img: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400', title: 'Empowering Communities' },
              { img: 'https://images.unsplash.com/photo-1594736797623-d0b6b5d0c42b?w=400', title: 'Preserving Traditions' },
              { img: 'https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=400', title: 'Creating Opportunities' }
            ].map((story, i) => (
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="w-full h-96 rounded-3xl overflow-hidden shadow-2xl border-4 border-amber-300">
                <img
                  src="https://images.unsplash.com/photo-1582582494409-7e4d7c5b0d7a?w=600"
                  alt="artisan community"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute inset-8 bg-gradient-to-br from-amber-900/10 to-transparent rounded-2xl border border-amber-200/50 backdrop-blur-sm flex items-center justify-center">
