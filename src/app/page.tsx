        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="bg- bg-amber-900/90  rounded-2xl  drop-shadow-md from-cream-50 to-amber-50 backdrop-blur-lg rounded-3xl p-8 hover:scale-105 transition-all duration-500 border border-amber-200/50 shadow-xl hover:shadow-2xl">
