    ...
    <div className="mt-3">
      {!isActive ? (
        <button
          ...
          className="w-full rounded-md bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-2 text-sm font-medium hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
        >
          {status === 'starting' ? (
            <>
